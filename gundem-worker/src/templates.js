    ...
    <div class="footer-grid">
      <div>
        ...
        <div style="margin-top: 24px; display: flex; gap: 16px;">
          ...
          <a href="https://vimeo.com/user2055109?fl=pp&amp;fe=sh" target="_blank" rel="noopener noreferrer"
            style="color: rgba(255,255,255,0.6); font-size: 13px; letter-spacing: 0.1em; text-transform: uppercase;">VIMEO</a>
        </div>
      </div>
      <div>
  ...
  <div class="wa-widget" id="wa-widget">
    <div class="wa-panel" id="wa-panel" hidden>
      <div class="wa-panel-header">
        <span>Hangi hizmetle ilgileniyorsunuz?</span>
        <button type="button" class="wa-panel-close" id="wa-close" aria-label="Kapat">&times;</button>
      </div>
      <div class="wa-panel-options">
        <a href="https://wa.me/905449588112?text=Merhaba%2C%20g%C3%B6rsel%20%C3%BCretimi%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum." target="_blank" rel="noopener noreferrer">Görsel Üretimi</a>
        <a href="https://wa.me/905449588112?text=Merhaba%2C%20video%20%C3%BCretimi%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum." target="_blank" rel="noopener noreferrer">Video Üretimi</a>
        <a href="https://wa.me/905449588112?text=Merhaba%2C%20hem%20g%C3%B6rsel%20hem%20video%20%C3%BCretimi%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum." target="_blank" rel="noopener noreferrer">Hem Görsel Hem Video Üretimi</a>
      </div>
    </div>
